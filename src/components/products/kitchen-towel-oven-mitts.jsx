...
import Image1 from '../../images/Bari Mills Website/Kitchen/Potholder & Oven Mitts/oven mits1.jpg'
import Image2 from '../../images/Bari Mills Website/Kitchen/Potholder & Oven Mitts/oven mits2.jpg'
import Image3 from '../../images/Bari Mills Website/Kitchen/Potholder & Oven Mitts/oven mits3.jpg'
import Image4 from '../../images/Bari Mills Website/Kitchen/Potholder & Oven Mitts/oven mits4.jpg'

function KitchenTowelOvenMitts() {
                ...
                <div className='everyDayTowelHeadFirstDiv'>
                    <div>
                        ...
                        <div className='everyDayTowelEveryDayTowelCollection'>
                            <p className='everyDayTowelEveryDayTowel'>Oven Mitts</p>
                            <p className='everyDayTowelCollection'>Collection</p>
                        </div>
                        <div className='everyDayTowelText'>
                            A wide selection of colorful fabric of Oven Mitts is offered by Bari Mills that are
                            designed to protect hand from hot ovens and surfaces while adding to kitchen decor.
                        </div>
                    </div>
                </div>
...
export default KitchenTowelOvenMitts