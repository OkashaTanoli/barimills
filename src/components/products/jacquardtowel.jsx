...
import Image1 from '../../images/Bari Mills Website/Terry Towel/Jackquard Towel/10.jpg'
import Image2 from '../../images/Bari Mills Website/Terry Towel/Jackquard Towel/11.jpg'
import Image3 from '../../images/Bari Mills Website/Terry Towel/Jackquard Towel/12.jpg'
import Image4 from '../../images/Bari Mills Website/Terry Towel/Jackquard Towel/13.jpg'
import Image5 from '../../images/Bari Mills Website/Terry Towel/Jackquard Towel/14.jpg'

function JacquardTowel() {
                ...
                <div className='everyDayTowelHeadFirstDiv'>
                    <div>
                        ...
                        <div className='everyDayTowelEveryDayTowelCollection'>
                            <p className='everyDayTowelEveryDayTowel' style={{ letterSpacing: '-3px', fontSize: '55px' }}>Jacquard Towel</p>
                            <p className='everyDayTowelCollection'>Collection</p>
                        </div>
                        <div className='everyDayTowelText'>
                            Jacquard Towels manufactured at Bari Mills are of premium quality, innovative designs and industrial masterpiece.
                            We have employed the most efficient and market leading machinery that helps our experts
                            of the field to acquire the desired product.
                        </div>
                    </div>
                </div>
